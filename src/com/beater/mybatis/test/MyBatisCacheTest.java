...
public class MyBatisCacheTest {
	 ...
	 *		4)、引用其他namespace的cache使用<cache-ref namespace=""></cache-ref>
	 * @throws IOException 
	 * 
	 */
	@Test
	public void testSecondLevelCache02() throws IOException{
		...
		try{
			//1、
			DepartmentDaoMapper mapper = openSession.getMapper(DepartmentDaoMapper.class);
			DepartmentDaoMapper mapper2 = openSession2.getMapper(DepartmentDaoMapper.class);
			
			Department deptById = mapper.getDepartmentByID(1);
			System.out.println(deptById);
			openSession.close();
			
			
			
			Department deptById2 = mapper2.getDepartmentByID(1);
	...
	public void testSecondLevelCache() throws IOException{
		...
		try{
			...
			EmployeeDaoMapper mapper2 = openSession2.getMapper(EmployeeDaoMapper.class);
